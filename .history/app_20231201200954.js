...
const defaultItems = [item0, item1, item2, item3, item4, item5, item6];
...
app.get("/:customListName", async function (req, res) {
    ...
    if (customListName === "app.js") {
        console.log("Ab aa k dikha bdsk");
    ...
    }; // if else loop to prevent creation of app.js doc in data base

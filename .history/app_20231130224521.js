...
app.post("/", async function (req, res) {
    ...
    const itemArray = new Item({
        name: itemName
    });

    itemArray.save().then(saveditemArray => {
        saveditemArray === itemArray; // true
    });
...
console.log(customListName);
    ...
    if (result === null) {
        ...
        res.render("toDoList", { listTitle: customListName, newListItems: result.itemArray });
    };
});
